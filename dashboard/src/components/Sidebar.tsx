...
export default function Sidebar({
  ...
  return (
    // Icon rail below md (roughly 56-64px, w-16), full icon+label sidebar
    // at md and up -- unchanged above that breakpoint.
    <nav className="w-16 md:w-56 shrink-0 h-screen sticky top-0 flex flex-col bg-white border-r border-neutral-200 px-2 md:px-3 py-6">
      <div className="hidden md:block px-3 mb-8">
          ...
          return (
            <li key={section}>
              <button
                ...
                className={`w-full flex items-center justify-center md:justify-start gap-0 md:gap-3 px-0 md:px-3 py-3.5 md:py-2.5 rounded-lg text-sm font-medium transition-colors ${
                  isActive
              ...
              >
                ...
                />
                <span className="hidden md:inline">{LABELS[section]}</span>
              </button>
            </li>
          );
        })}
